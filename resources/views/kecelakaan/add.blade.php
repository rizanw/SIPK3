                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input name="jumlahkorban" class="form-control" id="jumlah-korban" type="number" min="0"
                            ...
                            <div class="form-group">
                                <div class="form-check form-check-inline mr-1">
                                    <input class="form-check-input" id="inline-radio5-severity" type="radio" value="5"
                                           name="severity">
                            ...
                            <div class="form-group">
                                <div class="form-check form-check-inline mr-1">
                                    <input class="form-check-input" id="inline-radio4-severity" type="radio" value="4"
                                           name="severity">
                            ...
                            <div class="form-group">
                                <div class="form-check form-check-inline mr-1">
                                    <input class="form-check-input" id="inline-radio3-severity" type="radio" value="3"
                                           name="severity">
                            ...
                            <div class="form-group">
                                <div class="form-check form-check-inline mr-1">
                                    <input class="form-check-input" id="inline-radio2-severity" type="radio" value="2"
                                           name="severity">
                            ...
                            <div class="form-group">
                                <div class="form-check form-check-inline mr-1">
                                    <input class="form-check-input" id="inline-radio1-severity" type="radio" value="1"
                                           name="severity">
                            ...
                            <div class="form-group">
                                <div class="form-check form-check-inline mr-1">
                                    <input class="form-check-input" id="inline-radio5-likelihood" type="radio" value="5"
                                           name="likelihood">
                                    <label class="form-check-label" for="inline-radio5-likelihood">
                                        <strong>(Very High) :</strong>
                                        Sering terjadi;
                                        Untuk Insiden, minimal dalam waktu 1 bulan terakhir tdk pernah/berkemungkinan
                                        terjadi insiden;
                            ...
                            <div class="form-group">
                                <div class="form-check form-check-inline mr-1">
                                    <input class="form-check-input" id="inline-radio4-likelihood" type="radio" value="4"
                                           name="likelihood">
                                    <label class="form-check-label" for="inline-radio4-likelihood">
                                        <strong>(High) : </strong>
                                        Dapat terjadi, umumnya terjadi pada aktifitas rutin;
                                        Untuk Insiden, minimal dalam waktu 6 bulan terakhir tdk pernah/berkemungkinan
                                        terjadi insiden;
                                        Untuk paparan/exposure &/menghasilkan waste/polusi ke lingkungan terjadi pada
                                        aktifitas rutin dan disebabkan karena belum adanya program &/training
                                        &/perawatan.
                            ...
                            <div class="form-group">
                                <div class="form-check form-check-inline mr-1">
                                    <input class="form-check-input" id="inline-radio3-likelihood" type="radio" value="3"
                                           name="likelihood">
                                    <label class="form-check-label" for="inline-radio3-likelihood">
                                        ...
                                        Untuk paparan dan atau menghasilkan limbah / polusi ke lingkungan terjadi pada
                                        aktifitas normal.
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-check form-check-inline mr-1">
                                    <input class="form-check-input" id="inline-radio2-likelihood" type="radio" value="2"
                                           name="likelihood">
                            ...
                            <div class="form-group">
                                <div class="form-check form-check-inline mr-1">
                                    <input class="form-check-input" id="inline-radio1-likelihood" type="radio" value="1"
                                           name="likelihood">
                            ...
                            <div class="form-group">
                                ...
                                <input name="penanggung-jawab" class="form-control" id="penanggung-jawab" type="text"
